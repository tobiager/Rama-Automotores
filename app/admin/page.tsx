      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex space-x-4 border-b border-gray-700 pb-4">
          ...
          <Button
            ...
            className={`px-4 py-2 rounded-lg font-medium ${
              activeTab === "cotizacion" ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300 hover:bg-gray-600"
            }`}
          >
            Cotización
          </Button>
...
{activeTab === "cotizacion" && (
  <div className="mt-6">
    <h2 className="text-xl font-semibold mb-4">Subir nueva cotización (PDF)</h2>
